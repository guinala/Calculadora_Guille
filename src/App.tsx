...
function Calculator() {
  ...
  function calculateResult(display: string, lastOperation: string | undefined): number | undefined {
    try {
    ...
    <>
      <div className="calculator">
        ...
        <div className="buttons">
          ...
          <Button className="operator-button" onClick={changeSign}>
            +-
          </Button>
          <Button className="operator-button" onClick={percent}>
            %
          </Button>
          <Button
